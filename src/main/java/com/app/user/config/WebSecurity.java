...
public class WebSecurity extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().cors().disable().authorizeRequests().antMatchers("/static/images/**",
				...
				URLConstants.LOGIN_SERVICE + URLConstants.FORGET_PASSWORD,
				...
				URLConstants.REGISTRATION_SERVICE + URLConstants.GET_COUNT_OF_USER,
				...
				URLConstants.MASTER_SERVICE + URLConstants.GET_COUNT_OF_CLIENT,
				URLConstants.MASTER_SERVICE + URLConstants.ENABLE_DISABLE_CLIENT,
				URLConstants.MASTER_SERVICE + URLConstants.GET_COUNT,
				URLConstants.MASTER_SERVICE + URLConstants.GET_VEHICLE_BY_REG_NUMBER,
				...
				URLConstants.VEHICLE_INSPECTION + URLConstants.GET_VEHICLE_INSPECTION_BY_CLIENT_ID_USER_ID,
				...
				URLConstants.VEHICLE_INSPECTION + URLConstants.ENABLE_DISABLE_INSPECTION,
				URLConstants.VEHICLE_INSPECTION + URLConstants.GET_LAST_VEHICLE_INSPECTION_DATE,
				URLConstants.VEHICLE_INSPECTION + URLConstants.GET_VEHICLE_BY_REG_NUMBER,
				URLConstants.MASTER_SERVICE + URLConstants.SAVE_CLIENT_VEHICLE,
				URLConstants.MASTER_SERVICE + URLConstants.UPDATE_CLIENT_VEHICLE,
				URLConstants.MASTER_SERVICE + URLConstants.ENABLE_DISABLE_CLIENT_VEHICLE_MASTER,
				URLConstants.MASTER_SERVICE + URLConstants.GET_ALL_CLIENT_VEHICLE,
				URLConstants.MASTER_SERVICE + URLConstants.GET_CLIENT_VEHICLE_BY_CLIENT_ID,
				URLConstants.LOGIN_SERVICE + URLConstants.FORGOTE_PASSWORD,
				URLConstants.VEHICLE_INSPECTION + URLConstants.GET_VEHICLE_BY_USER_NAME,
				
				URLConstants.VEHICLE_INSPECTION + URLConstants.GET_INSPECTION_DONE_BY_CLIENT_ID_LOCATION_ID,
				URLConstants.VEHICLE_INSPECTION + URLConstants.GET_TOP_TEN_ISSUE_CLIENT_ID_AND_VEHICLE_ID,
				URLConstants.VEHICLE_INSPECTION + URLConstants.GET_TIRE_DETAILS_BY_INSPECTION_ID_CLIENT_ID,
				URLConstants.MASTER_SERVICE + URLConstants.GET_CLIENT_VEHICLE_BY_CLIENT_ID_AND_LOCATION_ID,
				URLConstants.MASTER_SERVICE + URLConstants.CLIENT_LOGIN_USER,
				...
				URLConstants.MASTER_SERVICE + URLConstants.GET_CLIENT_VEHICLE_BY_ID,
